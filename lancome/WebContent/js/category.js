(function($) {
	...
	btn_up.src = "img/ui/up.png";
	btn_down.src = "img/ui/down.png";
	var Menu = {
		// 初始化事件
		initEvent : function() {
			$().ready(
		...
		showMenu2 : function($curMenuDom) {
		    var menu_bar = $curMenuDom.find("div.crow_row");
			var next = $curMenuDom.children("ul");
